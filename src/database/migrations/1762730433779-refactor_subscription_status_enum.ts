...
export class RefactorSubscriptionStatusEnum1762730433779 implements MigrationInterface {
    name = 'RefactorSubscriptionStatusEnum1762730433779'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."subscriptions_status_enum" RENAME TO "subscriptions_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."subscriptions_status_enum" AS ENUM('ACTIVE', 'EXPIRED', 'CANCELED', 'INCOMPLETE', 'PAUSED')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."subscriptions_status_enum_old" AS ENUM('ACTIVE', 'EXPIRED', 'CANCELED', 'PENDING_FOR_PAYMENT')`);
